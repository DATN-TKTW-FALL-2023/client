  ...
  return (
    <div>
      <div className="container">
        <h3 className="text-2xl mt-14 mb-4">
        <label>Trang chủ &gt; </label> <span className="text-[#03599d]" >{film?.data?.name}</span>
        </h3>
            ...
            <div className="grid grid-cols-[150px_minmax(420px,_1fr)_100px]">
              ...
              <div>
                <h3 className="text-lg font-light">
                  {film?.data?.taxonomies?.map((taxonomy: any, index: any) => (
              ...
              return (
                <div
                  className={`my-2 px-4 py-1 text-center cursor-pointer ${
                    selectedDay === dateString ? "bg-[#03599d]" : "bg-transparent"
                  }`}
                  key={index}
      ...
      {film?.data?.trailerUrl && (
        ...
        <div className="bg-[#3c3e4d]">
          <div className="container p-12 pb-20">
            {film?.data?.trailerUrl && (
              <div>
                <div className="w-[140px] mx-auto">
                  <h1 className="font-bold text-white text-center text-[30px] br pb-4 mb-10 border-b-4 border-indigo-500 ">TRAILER</h1>
                </div>
                <iframe width="100%"
                    height="555" src={film?.data?.trailerUrl} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
