      ...
      <div className="footer border-t-2 border-[#ccc]">
        <div className="container py-10 grid grid-cols-3">
          <div>
            ...
            <div>
              <ul>
                <li className="font-bold text-[14px] hover:text-sky-700 cursor-pointer py-[2px]">
                  Tuyển dụng
                </li>
                <li className="font-bold text-[14px] hover:text-sky-700 cursor-pointer py-[2px]">
                  Giới thiệu
          ...
          <div>
            <h2 className="br font-bold text-xl inline-block mb-4">
          ...
          <div>
            <h2 className="br font-bold text-xl inline-block mb-4">LIÊN HỆ</h2>
            <div>
              <h4 className="font-bold text-[15px]">
                CÔNG TY CỔ PHẦN BETA FREE FIRE
              </h4>
              <h6 className="font-bold text-[14px] text-xs py-2">
